...
class MoveListDialog(Adw.MessageDialog):
    ...
    def __init__(self, parent, row_to_move, favorites_view_widget):
        ...
        self.favorites_view_widget = favorites_view_widget
        self.set_heading(_("Move List"))
        list_name = getattr(self.row_to_move, "list_name", _("Unknown List"))
        self.set_body(f"'{list_name}'")
        self.set_default_size(300, -1)
        self.add_css_class("move-list-dialog")
